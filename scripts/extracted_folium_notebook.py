...
# Using KSC LC-39A launch site as example
...
coordinates = [coordinate, coastline_coord]
lines = folium.PolyLine(locations=coordinates, weight=1)
site_map.add_child(lines)

# Cell 18
# Create a marker with distance to the closest city
# Using Titusville, FL as the closest city to KSC LC-39A
city_lat = 28.6122
city_lon = -80.8076
...
city_line = folium.PolyLine(locations=[coordinate, city_coord], weight=1)
site_map.add_child(city_line)

# Cell 19
# Create a `folium.PolyLine` between a launch site to the selected coastline point
...
railway_line = folium.PolyLine(locations=[coordinate, railway_coord], weight=1)
site_map.add_child(railway_line)

# Cell 20
# Create a marker with distance to a closest highway
# Closest highway (US-1) to KSC LC-39A
highway_lat = 28.5634
highway_lon = -80.5707
...
highway_line = folium.PolyLine(locations=[coordinate, highway_coord], weight=1)
